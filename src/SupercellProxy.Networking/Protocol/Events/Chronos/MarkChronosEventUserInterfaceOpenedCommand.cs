...
/// </summary>
public sealed record MarkChronosEventUserInterfaceOpenedCommand(
...
) : Command(ExecutionPhaseCounter, DebugData0, DebugData1)
{
    ...
    public static MarkChronosEventUserInterfaceOpenedCommand Decode(MessageStream stream, CommandEnvironment environment)
    {
        ...
        return new MarkChronosEventUserInterfaceOpenedCommand(stream.ReadVariableInt(), fields.ExecutionPhaseCounter, fields.DebugData0, fields.DebugData1);
    }
