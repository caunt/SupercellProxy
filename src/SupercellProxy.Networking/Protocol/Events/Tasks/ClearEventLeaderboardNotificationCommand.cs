...
/// </summary>
public sealed record ClearEventLeaderboardNotificationCommand(
...
) : Command(ExecutionPhaseCounter, DebugData0, DebugData1)
{
    ...
    public static ClearEventLeaderboardNotificationCommand Decode(MessageStream stream, CommandEnvironment environment)
    {
        ...
        return new ClearEventLeaderboardNotificationCommand(eventIdentifier, state, fields.ExecutionPhaseCounter, fields.DebugData0, fields.DebugData1);
    }
    ...
    public override void EncodeBody(MessageStream stream, CommandEnvironment environment)
    {
        ...
        stream.WriteVariableInt(ButtonState);
