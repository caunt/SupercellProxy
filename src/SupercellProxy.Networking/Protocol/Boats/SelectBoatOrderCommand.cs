...
/// </summary>
public sealed record SelectBoatOrderCommand(int OrderIndex, int ExecutionPhaseCounter = -1, CommandData? DebugData0 = null, CommandData? DebugData1 = null) : Command(ExecutionPhaseCounter, DebugData0, DebugData1)
{
    /// <summary>
    /// Gets the Type value.
    /// </summary>
    ...
    public static SelectBoatOrderCommand Decode(MessageStream stream, CommandEnvironment environment)
    {
        ...
        return new SelectBoatOrderCommand(stream.ReadVariableInt(), fields.ExecutionPhaseCounter, fields.DebugData0, fields.DebugData1);
    }
