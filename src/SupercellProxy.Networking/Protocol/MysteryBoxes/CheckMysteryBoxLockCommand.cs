...
/// </summary>
public sealed record CheckMysteryBoxLockCommand(
...
) : Command(ExecutionPhaseCounter, DebugData0, DebugData1)
{
    ...
    public static CheckMysteryBoxLockCommand Decode(MessageStream stream, CommandEnvironment environment)
    {
        ...
        return new CheckMysteryBoxLockCommand(box, fields.ExecutionPhaseCounter, fields.DebugData0, fields.DebugData1);
    }
