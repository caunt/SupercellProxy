...
/// <summary>
/// Tracks <c language="csharp">AvatarManagerBState</c> during turn simulation.
/// </summary>
internal sealed record AvatarManagerBState(int Unknown0, int Unknown1, int Unknown2, long Unknown3)
{
